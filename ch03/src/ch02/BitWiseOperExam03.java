...
public class BitWiseOperExam03 {
	...
	public static void main(String[] args) {
		...
		short a = (short)0x55ff; //5 5 15 15 =>5*16^3 + 5*16^2 + 15*16^1 + 15*16^0 => 22015
						//5      5     f     f
						//0101  0101  1111  1111
		...
		System.out.printf("%04x\n",(short)(a|b));//
		System.out.printf("%04x\n",(short)(a^b));
		System.out.printf("%04x\n",(short)(~a));//~0101  0101  1111  1111=> (비트로 계산할 때는 2진수로)1010 1010 0000 0000 => (표현할 때는 16진수)10 10 0 0 => a a 0 0
